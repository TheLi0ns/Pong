...
import com.TheLi0ns.GameStates.MenusHandling.SubMenus.GameModeSubMenu;
...
public class TitleScreen extends Menu{
    ...
    public void performOption() {
        ...
        else if(selectedOption == MINI_GAMES_OPTION.ID) gl.setGameState(new MiniGamesMenu(gl));

        else if (selectedOption == SETTINGS_OPTION.ID) gl.setGameState(new SettingsMenu(gl));
